...
const ChatSidebar = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b border-gray-700">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`p-2.5 rounded-lg transition-colors text-white ${showAllUsers ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"}`}
          >
            {showAllUsers ? <X className="w-4 h-4"></X> : <Plus className="w-4 h-4"></Plus>}
          </button>
        </div>
      </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-400 mt-0.5">{/** to show online offline text */}</div>
                      </div>
                    </div>
                  </button>
                ))}
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-lg transition-colors border ${
                    isSelected ? "bg-blue-600 border-blue-500" : "border-gray-700 hover:border-gray-600"
                  }`}
                  key={chat.chat._id}
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {latestMessage && (
                        <div className="flex items-center gap-2">
                          {isSentByMe ? <CornerUpLeft size={14} className="text-blue-400" /> : <CornerDownRight size={14} className="text-green-400" />}
      ...
      {/** footer */}
      <div className="p-4 bottom-0 border-t border-gray-700 space-y-2">
